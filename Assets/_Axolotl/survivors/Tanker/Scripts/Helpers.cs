...
namespace Axolotl.Tanker.Modules
{
    internal static class Helpers
    {
        ...
        {
            var state = new SerializableEntityStateType(typeof(Axolotl.Tanker.SkillStates.Shoot));
            Debug.LogWarning(TankerPlugin.MODNAME + ": DEBUG: TypeName print: " + state.typeName);
        }
    }
